...
export const messages: Record<string, Message> = {
  ...
  how_day: {
    ...
    sent: new Date("January 3rd, 2020 2:05pm"),
    id: 938,
    parent: 5,
  },
  good_day: {
    ...
    sent: new Date("January 3rd, 2020 2:06pm"),
    id: 939,
    parent: 5,
  },
  oh_see: {
    ...
    sent: new Date("January 3rd, 2020 2:07pm"),
    id: 263,
    parent: 5,
  },
  banana: {
    ...
    sent: new Date("January 3rd, 2020 2:08pm"),
    id: 265,
    parent: 5,
  },
  no_breakfast: {
    ...
    sent: new Date("January 3rd, 2020 2:09pm"),
    id: 268,
    parent: 5,
  },
  面白い: {
    user: users.bob,
    markdown: "## 面白い",
    sent: new Date("January 3rd, 2020 2:10pm"),
    id: 269,
    parent: 5,
  },
  spam1: {
